...
class TestTenantIsolationMiddleware:
    ...
    @pytest.mark.asyncio
    async def test_missing_auth_for_api_path(self, middleware, mock_request):
    ...
    @pytest.mark.asyncio
    async def test_valid_tenant_extraction(self, middleware, mock_request):
    ...
    @pytest.mark.asyncio
    async def test_extract_tenant_from_valid_token(self, middleware, mock_request):
    ...
    @pytest.mark.asyncio
    async def test_extract_tenant_from_invalid_token(self, middleware, mock_request):
    ...
    def test_tenant_context_manager_get_tenant_id(self):
    ...
    def test_tenant_context_manager_require_tenant_id_success(self):
...
class TestRateLimitMiddleware:
    ...
    @pytest.mark.asyncio
    async def test_excluded_paths_bypass(self, middleware, mock_request):
    ...
    @pytest.mark.asyncio
    async def test_no_redis_bypass(self, mock_request):
...
class TestRateLimitService:
    ...
    @pytest.mark.asyncio
    async def test_get_rate_limit_status(self, rate_limit_service, mock_redis):
    ...
    @pytest.mark.asyncio
    async def test_reset_rate_limit(self, rate_limit_service, mock_redis):
    ...
    @pytest.mark.asyncio
    async def test_set_custom_limit(self, rate_limit_service, mock_redis):
...
class TestSecurityHeadersMiddleware:
    ...
    @pytest.mark.asyncio
    async def test_csp_header_content(self, middleware):
...
class TestCSRFProtectionMiddleware:
    ...
    @pytest.mark.asyncio
    async def test_get_method_bypass(self, middleware, mock_request):
    ...
    @pytest.mark.asyncio
    async def test_api_endpoints_bypass(self, middleware, mock_request):
    ...
    @pytest.mark.asyncio
    async def test_missing_csrf_token(self, middleware, mock_request):
...
class TestSecurityService:
    ...
    def test_generate_audit_log_entry(self):
