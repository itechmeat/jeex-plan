...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_document_versions_project_type",
        "document_versions",
        ["project_id", "document_type"],
    )
    op.create_index(
        "idx_document_versions_project_version",
        "document_versions",
        ["project_id", "version"],
    )
    op.create_index(
        "idx_document_versions_tenant_created",
        "document_versions",
        ["tenant_id", "created_at"],
    )
    op.create_index(
        "idx_document_versions_epic", "document_versions", ["project_id", "epic_number"]
    )
    op.create_index(
        "idx_document_versions_tenant_id", "document_versions", ["tenant_id"]
    )
    op.create_index(
        "idx_document_versions_is_deleted", "document_versions", ["is_deleted"]
    )
    op.create_index(
    ...
    op.create_index(
        ...
        postgresql_where=sa.text(
            "epic_number IS NOT NULL AND document_type = 'plan_epic'"
        ),
    )
    ...
    op.create_index(
        "idx_agent_executions_project_started",
        "agent_executions",
        ["project_id", "started_at"],
    )
    op.create_index(
        "idx_agent_executions_correlation", "agent_executions", ["correlation_id"]
    )
    op.create_index(
    ...
    op.create_index(
        "idx_agent_executions_tenant_agent_type",
        "agent_executions",
        ["tenant_id", "agent_type"],
    )
    op.create_index("idx_agent_executions_tenant_id", "agent_executions", ["tenant_id"])
    op.create_index(
        "idx_agent_executions_is_deleted", "agent_executions", ["is_deleted"]
    )
    op.create_index(
        "idx_agent_executions_agent_type", "agent_executions", ["agent_type"]
    )
    ...
    op.create_index(
        "idx_exports_tenant_created", "exports", ["tenant_id", "created_at"]
    )
