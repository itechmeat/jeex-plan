...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_documents_is_deleted", "documents", ["is_deleted"], unique=False
    )

    # Additional performance indexes
    op.create_index(
        "ix_users_tenant_email", "users", ["tenant_id", "email"], unique=False
    )
    op.create_index(
        "ix_projects_tenant_status", "projects", ["tenant_id", "status"], unique=False
    )
    op.create_index(
